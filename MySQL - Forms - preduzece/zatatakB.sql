...
CREATE TABLE artikal (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, 
                        ...
                        porez decimal(10,2) AS (kupovna_cena/5),
                        prodajna_cena decimal (10,2) AS (kupovna_cena + porez), 
...
CREATE TABLE ponuda (id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, 
                        ...
                        cena decimal(10,2), 
                        kolicina int(10), 
                        vrednost decimal(10,2) AS (cena * kolicina),
						porez decimal(10,2) AS (vrednost/5), 
                        vrednost_sa_porezom decimal (10,2) AS (porez + vrednost),
                        srednja_prodajna_vrednost decimal (10,2) AS (vrednost_sa_porezom / kolicina));
